...
export default function NewsInsights() {
  const articles = [
    ...
    },
    {
      ...
      excerpt: "Complete guide for first-time homebuyers in California and Washington, including loan programs, down payment assistance, and expert tips.",
    ...
    },
    {
      ...
      icon: DollarSign,
      title: "California & Washington Mortgage Refinance Specialist",
      excerpt: "Learn about refinancing options across California and Washington with expert guidance on rates, timing, and maximizing your savings.",
