...
export const defaultMortgageFAQs: FAQItem[] = [
  {
    ...
    answer: "A mortgage broker acts as an intermediary between borrowers and multiple lenders. Unlike banks that only offer their own loan products, mortgage brokers have access to 200+ lenders and can shop your loan to find competitive pricing, terms, and loan programs that match your specific financial situation. Brokers handle the entire loan process from application to closing, saving you time and potentially thousands of dollars."
  },
  {
  ...
  },
  {
    ...
    answer: "Mortgage brokers offer several key advantages: access to 200+ lenders vs. one bank's products, competitive shopping for favorable pricing and terms, expert guidance through complex loan programs, personalized service throughout the process, and often competitive pricing compared to retail banks. Brokers work for you, not the lender, ensuring you get the loan that fits your needs and financial goals."
  }
];
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mt-12">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="/contact"
              className="bg-slate-900 hover:bg-slate-800 text-white px-8 py-3 rounded-lg font-semibold transition-colors duration-200"
            >
              Get Expert Guidance
            </a>
            <a
