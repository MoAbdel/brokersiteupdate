  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      ...
      if (typeof window !== 'undefined' && (window as typeof window & { gtag?: (...args: unknown[]) => void }).gtag) {
        (window as typeof window & { gtag: (...args: unknown[]) => void }).gtag('event', 'geo_performance_scan', {
      ...
      if (typeof window !== 'undefined') {
        (window as typeof window & { geoMetrics?: GEOMetrics }).geoMetrics = metrics;
      }
    }, 1000);
...
export const manualGEOTrack = (): GEOMetrics | null => {
  if (typeof window !== 'undefined') {
    return (window as typeof window & { geoMetrics?: GEOMetrics }).geoMetrics || null;
  }
  return null;
};