...
export default function CookieBanner() {
  ...
  return (
    <div
      ...
      aria-live="polite"
      className="hidden sm:flex fixed bottom-0 left-0 right-0 z-[99999] bg-slate-900 border-t border-slate-700 px-4 py-3 justify-center"
    >
      <div className="flex w-full max-w-2xl flex-col items-center justify-center gap-3 text-center 2xl:flex-row">
