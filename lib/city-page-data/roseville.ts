...
export const roseville: CityPageData = {
  ...
  localMarketProse: [
    ...
    "What brings buyers to Roseville is a combination of strong public schools, proximity to Sacramento-metro employment (a roughly 25-minute commute to downtown Sacramento), the extensive retail and dining anchored by the Galleria, and housing options ranging from starter SFR to active-adult planned communities like Sun City. For existing owners, HELOC and cash-out demand has been steady through 2026 — particularly among 2020-2022 purchase cohorts who want to tap equity for renovations or debt consolidation while preserving their low first-mortgage rate. Roseville's owner-occupancy share of about 66% (2020) supports a consistent equity-lending volume.",
  ].join('\n\n'),
  faqOverrides: [
    {
