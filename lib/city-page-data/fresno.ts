...
export const fresno: CityPageData = {
  ...
  localMarketProse: [
    ...
    "What brings buyers to Fresno is a combination of dramatic affordability relative to coastal California, growing job opportunities in logistics (Amazon, Gap, Ulta distribution), healthcare, and education, and a market that still offers entry-level single-family homes under $400,000. Homes sell in about 50 days on average — slower than 2022 peaks but still reasonable for a balanced market. For existing owners, HELOC demand is steady and DSCR refinance on investment properties is a specific Fresno-strong signal — one of the few Tier 1 city queries with actual DSCR-investor search volume, per our GSC read.",
  ].join('\n\n'),
  faqOverrides: [
    {
