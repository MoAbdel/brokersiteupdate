...
export const longBeach: CityPageData = {
  ...
  localMarketProse: [
    ...
    "What brings buyers to Long Beach is a combination of relative affordability (compared to Westside LA and Orange County), proximity to both LA and OC job markets, diverse housing stock at multiple price points, and walkable historic neighborhoods with solid public-transit access. For existing owners, HELOC and cash-out demand has been strong throughout 2026 — especially among homeowners who bought at 2020-2022 rates and want to tap equity for renovations, investment properties, or debt consolidation while preserving their first-mortgage rate intact. Property-tax questions drive the largest Long Beach-specific GSC signal we see, reflecting buyers and owners trying to budget total monthly housing costs accurately before making their next move.",
  ].join('\n\n'),
  faqOverrides: [
    {
