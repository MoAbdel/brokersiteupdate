...
| Phone | (949) 579-2057 |
| Lender Network | Use live repo truth for the target page family — never hardcode from memory |
...
- **NEVER invent or normalize lender counts from memory** — mirror the live repo truth for that page family, or use non-numeric "lender-network" wording
...
### D. Lender Count
- Do **NOT** standardize to one universal lender count across every page
- If the live repo already uses a page-family-specific count, mirror that exact approved wording
- If no live numeric claim exists, prefer non-numeric language such as **"broad lender network"** or **"access to multiple lenders"**
- **NEVER invent** "50+ lenders", "100+ lenders", or "200+ lenders" from memory
...
```
✅ "Competitive options through the broker channel"
✅ "Access to a broad lender network"
✅ "Multiple lender options for your situation"
...
- [ ] Phone, states, qualification ranges, and lender-network wording match live repo truth
...
- [ ] Any lender-count claim mirrors live repo truth for that page family
...
broker with access to a broad lender network, I shop multiple lenders to help
