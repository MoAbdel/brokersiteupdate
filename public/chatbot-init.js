...
(function() {
  ...
  function getIndependentResponse(message) {
    ...
    if (msg.includes('rate') || msg.includes('interest')) {
      return 'Current rates vary by loan type and credit score. Today\\'s rates are approximately: 30-year fixed at 6.53%, 15-year fixed at 5.88%, FHA at 6.09%. With my wholesale lender access, I consistently secure competitive rates. Call me at <a href="tel:9498229662" style="color: #2563eb;">(949) 822-9662</a> for your personalized loan quote.';
    }
