...
export const metadata: Metadata = {
  ...
  description: 'Summer 2026 Orange County real estate market guide. Peak season strategies, competition insights, inventory trends, and expert buying tips. Call (949) 537-2357.',
  alternates: {
  ...
  const schemaData = [
    {
      ...
      url: 'https://mothebroker.com/guides/summer-2026-market-guide',
      data: {
        author: 'Mo Abdel',
  ...
  return (
    <>
      ...
      <AIOOptimization
        ...
        city="Orange County"
        canonicalUrl="https://mothebroker.com/guides/summer-2026-market-guide"
