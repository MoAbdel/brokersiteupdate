...
export const metadata: Metadata = {
  ...
  description: 'Spring 2025 Orange County home buying guide. Market trends, mortgage pricing, inventory levels, and expert tips for successful spring home purchases. Call (949) 822-9662.',
  alternates: {
