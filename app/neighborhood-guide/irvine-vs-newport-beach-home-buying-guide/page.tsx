...
import { AlertTriangle, Car, CheckCircle, GraduationCap, Home, MapPin } from 'lucide-react';
...
export const metadata: Metadata = {
  ...
  alternates: {
    ...
    languages: {
      'en-US': 'https://www.mothebroker.com/neighborhood-guide/irvine-vs-newport-beach-home-buying-guide',
      'x-default': 'https://www.mothebroker.com/neighborhood-guide/irvine-vs-newport-beach-home-buying-guide',
    },
  },
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div>
              <h3 className="text-2xl font-bold text-blue-600 mb-4">Top Irvine Neighborhoods</h3>
        ...
        <div className="bg-slate-100 rounded-lg p-8 mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <h3 className="text-xl font-semibold mb-4 text-blue-600">Irvine Market Outlook</h3>
              <ul className="space-y-2 text-slate-700">
