...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return genMeta({
    title: `DSCR Qualification Calculator — All ${counties.length} ${stateName} Counties [2026 Investment Property Tool]`,
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <nav aria-label="Breadcrumb" className="mb-6">
          <ol className="flex items-center gap-1 text-sm text-slate-500">
            ...
            <li><span className="mx-1">/</span></li>
            <li><Link href="/tools/dscr-qualification-calculator" className="hover:text-blue-600">DSCR Qualification Calculator</Link></li>
            <li><span className="mx-1">/</span></li>
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-slate-900 mb-4">
            {stateName} DSCR Qualification Calculator by County
          </h1>
          <p className="text-lg text-slate-600 max-w-3xl mx-auto">
            {stateName} has {counties.length} counties with an average median rent of{' '}
            {formatCurrency(avgRent)}/mo. Select your county to check DSCR loan qualification.
          </p>
        </div>
