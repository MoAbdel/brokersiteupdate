...
export const metadata: Metadata = {
  ...
  description: 'Current Orange County FHA loan limits for 2026. $1,209,750 limit allows FHA financing for most OC homes. Licensed FHA specialist Mo Abdel (949) 579-2057.',
  openGraph: {
  ...
  alternates: {
    ...
    languages: {
      'en-US': 'https://www.mothebroker.com/loan-programs/orange-county-fha-loan-limits',
      'x-default': 'https://www.mothebroker.com/loan-programs/orange-county-fha-loan-limits',
    },
  },
};
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <Card className="border-l-4 border-l-blue-500">
              <CardContent className="p-6 text-center">
                ...
                <div className="text-2xl font-bold text-blue-600">$1,621,200</div>
