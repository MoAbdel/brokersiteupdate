...
export const metadata: Metadata = {
  ...
  description: 'Fix & flip loans in Orange County for real estate investors. Quick 7-10 day closings, up to 90% ARV, 6-24 month terms. Experienced investor lender. Call (949) 537-2357.',
  alternates: {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-purple-600 text-white rounded-lg p-8 text-center">
          ...
          <p className="text-purple-100 mt-4">
            Licensed mortgage broker with West Capital Lending • NMLS #1426884 • Investor Specialist
          </p>
        </div>
