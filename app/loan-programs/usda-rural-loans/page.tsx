...
export const metadata: Metadata = {
  ...
  description: 'USDA rural loans in eligible Orange County areas. 0% down payment, Competitive pricing, income limits apply. Perfect for first-time buyers in rural/suburban areas. Call or Text (949) 579-2057.',
  alternates: {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-slate-900 text-white rounded-lg p-8 text-center">
          ...
          <p className="text-yellow-100 mt-4">
            Licensed mortgage broker with Lumin Lending • NMLS #1426884 • USDA Approved Lender
          </p>
        </div>
