...
const faqs = [
  ...
  },
  {
    ...
    answer: "Fixed-rate home equity loans are typically structured within the conforming cap of $1,209,750, with FHA-backed options capped at $1,209,750. However, many HELOAN programs can go higher depending on your home's value and lender guidelines. Orange County's high property values often allow for substantial borrowing capacity."
  },
  {
...
export default function HELOANOrangeCountyPage() {
  return (
    <article aria-label="Orange County home equity loan HELOAN options">
      ...
      <Breadcrumbs pathname="/heloan-orange-county" />
      ...
      <div className="min-h-screen py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <section className="mb-16 bg-slate-50 rounded-xl p-8" aria-label="2026 home equity loan limits in Orange County">
            ...
            <div className="max-w-4xl mx-auto">
              <p className="text-lg text-slate-700 mb-6 text-center" data-speakable="true">
                ...
                with FHA-backed options capped at <strong>$1,209,750</strong>. With Orange County's high property values,
          ...
          <section className="mb-16" aria-label="Compare home equity loan with refinancing options">
            <h2 className="text-2xl font-bold text-slate-900 mb-4 text-center">
              Compare with Refinancing Options
            </h2>
            <p className="text-slate-600 text-center mb-6 max-w-2xl mx-auto">
              A cash-out refinance replaces your entire first mortgage, while a HELOAN adds a second lien. Explore city-specific refinance guides to see which approach fits your situation.
            </p>
