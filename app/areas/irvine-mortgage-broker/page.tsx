...
export const metadata: Metadata = {
  ...
  description: 'Irvine mortgage broker with Competitive pricing. HELOC, refinancing, FHA, VA, and jumbo loans. Serving University Park, Woodbridge, Northwood. Call or Text (949) 579-2057.',
  alternates: {
