...
export const metadata: Metadata = {
  ...
  description: 'Corona del Mar Newport Beach mortgage broker specializing in luxury coastal home financing. Prestigious beachside community loans, Competitive pricing. Call or Text (949) 579-2057.',
  alternates: {
