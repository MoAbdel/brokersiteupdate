...
export const metadata: Metadata = {
  ...
  description: 'Balboa Island mortgage broker specializing in luxury waterfront home financing. Jumbo loans, investment property loans, and unique property financing. Call or Text (949) 579-2057.',
  alternates: {
