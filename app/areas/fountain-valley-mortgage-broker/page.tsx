...
export const metadata: Metadata = {
  ...
  description: 'Fountain Valley mortgage broker Mo Abdel offers competitive home loan rates. FHA, VA, conventional loans in Fountain Valley CA. Got mortgage questions? Call or Text (949) 579-2057.',
  openGraph: {
