...
export const metadata: Metadata = {
  ...
  alternates: {
    ...
    languages: {
      'en-US': 'https://www.mothebroker.com/areas/costa-mesa-mortgage-broker',
      'x-default': 'https://www.mothebroker.com/areas/costa-mesa-mortgage-broker',
    },
  },
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-slate-600 max-w-3xl mx-auto mb-8">
            ...
            <Link href="/areas/huntington-beach-mortgage-broker" className="text-blue-600 hover:text-blue-700 font-medium">Huntington Beach mortgage services</Link>.
          </p>
        ...
        {/* Why Costa Mesa Homeowners Choose Lumin Lending */}
        ...
        <div className="text-center bg-slate-900 rounded-2xl p-8 text-white">
          ...
          <p className="text-sm text-slate-200 mt-4">
            Licensed mortgage broker with Lumin Lending • NMLS #1426884 • Serving all Costa Mesa neighborhoods
          </p>
        </div>
      </div>
    </div>
