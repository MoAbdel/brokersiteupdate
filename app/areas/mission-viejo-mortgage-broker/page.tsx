  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {/* Mission Viejo Refinance Options */}
        <div className="mb-16">
          <h2 className="text-2xl font-bold text-center text-slate-900 mb-6">
            Mission Viejo Refinance Options
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Link href="/areas/mission-viejo-cash-out-refinance" className="p-4 bg-white rounded-lg shadow hover:shadow-md transition-shadow border border-slate-200">
              <span className="text-blue-600 font-medium text-lg">Mission Viejo Cash-Out Refinance</span>
              <p className="text-slate-600 text-sm mt-1">Access your Mission Viejo home equity with a cash-out refinance</p>
            </Link>
            <Link href="/areas/mission-viejo-rate-term-refinance" className="p-4 bg-white rounded-lg shadow hover:shadow-md transition-shadow border border-slate-200">
              <span className="text-blue-600 font-medium text-lg">Mission Viejo Rate &amp; Term Refinance</span>
