...
export const metadata: Metadata = {
  ...
  description: 'Irvine Unified School District mortgage broker specializing in homes within top-rated IUSD boundaries. Expert financing for families prioritizing education. Call or Text (949) 579-2057.',
  alternates: {
