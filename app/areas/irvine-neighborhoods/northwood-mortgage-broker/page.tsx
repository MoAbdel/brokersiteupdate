...
import { MapPin, Home, Building2, Calculator, Phone, Sparkles } from 'lucide-react';
...
export const metadata: Metadata = {
  ...
  description: 'Northwood Irvine mortgage broker specializing in newer construction homes. Modern amenities, family community, competitive financing. Call or Text (949) 579-2057.',
  alternates: {
