...
export const metadata: Metadata = {
  ...
  description: 'Northwood Irvine mortgage broker specializing in newer construction homes. Modern amenities, family community, competitive financing. Call (949) 537-2357.',
  alternates: {
