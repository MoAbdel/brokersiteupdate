...
export const metadata: Metadata = {
  ...
  description: 'Turtle Rock Irvine mortgage broker specializing in upscale family community homes. Established neighborhood financing, luxury amenities, Competitive pricing. Call (949) 822-9662.',
  alternates: {
