...
export const metadata: Metadata = {
  ...
  description: 'Woodbridge Irvine mortgage broker specializing in lake community homes. Established neighborhood financing, family-friendly loans, Competitive pricing. Call or Text (949) 579-2057.',
  alternates: {
    canonical: 'https://www.mothebroker.com/areas/irvine-neighborhoods/woodbridge-mortgage-broker',
    languages: {
      'en-US': 'https://www.mothebroker.com/areas/irvine-neighborhoods/woodbridge-mortgage-broker',
      'x-default': 'https://www.mothebroker.com/areas/irvine-neighborhoods/woodbridge-mortgage-broker',
    },
  },
};
...
export default function WoodbridgeMortgageBrokerPage() {
  ...
  return (
    <>
      ...
      <AIOOptimization
        title="Woodbridge Irvine Mortgage Broker | Lake Community Home Loans | Mo Abdel NMLS #1426884"
        description="Woodbridge Irvine mortgage broker specializing in lake community homes. Established neighborhood financing, family-friendly loans, Competitive pricing."
