...
export default function DebtToIncomeCalculatorClient() {
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-slate-900 mb-4">Debt-to-Income Ratio Calculator</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8">
            ...
            <div className="space-y-6">
              <div>
                <label className="block text-sm font-medium text-slate-700 mb-2">Gross Monthly Income</label>
              ...
              <div className="border-t border-slate-200 pt-6">
                ...
                <div className="space-y-4">
                  <div>
                    <label className="block text-sm font-medium text-slate-700 mb-2">Proposed Housing Payment</label>
                    <div className="relative">
                      <DollarSign className="absolute left-3 top-1/2 transform -translate-y-1/2 text-slate-400 w-5 h-5" />
                      <input
                        type="number"
                  ...
                  <div>
                    <label className="block text-sm font-medium text-slate-700 mb-2">Car Payments</label>
                    <div className="relative">
                      <DollarSign className="absolute left-3 top-1/2 transform -translate-y-1/2 text-slate-400 w-5 h-5" />
                      <input
                        type="number"
                  ...
                  <div>
                    <label className="block text-sm font-medium text-slate-700 mb-2">Credit Card Minimum Payments</label>
                    <div className="relative">
                      <DollarSign className="absolute left-3 top-1/2 transform -translate-y-1/2 text-slate-400 w-5 h-5" />
                      <input
                        type="number"
                  ...
                  <div>
                    <label className="block text-sm font-medium text-slate-700 mb-2">Student Loan Payments</label>
                    <div className="relative">
                      <DollarSign className="absolute left-3 top-1/2 transform -translate-y-1/2 text-slate-400 w-5 h-5" />
                      <input
                        type="number"
                  ...
                  <div>
                    <label className="block text-sm font-medium text-slate-700 mb-2">Other Monthly Debts</label>
                    <div className="relative">
                      <DollarSign className="absolute left-3 top-1/2 transform -translate-y-1/2 text-slate-400 w-5 h-5" />
                      <input
                        type="number"
              ...
              <Button onClick={calculateDTI} className="w-full bg-slate-900 hover:bg-slate-800 text-white py-3 text-lg font-semibold">
        ...
        <div className="mt-12 bg-white rounded-2xl shadow-lg border border-gray-200 p-8">
          ...
          <div className="mt-8 pt-8 border-t border-slate-200 text-center">
            <p className="text-slate-600 mb-4">Need help improving your DTI or finding the right loan program? Mo Abdel can help.</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="tel:(949) 579-2057">
                <Button className="bg-slate-900 hover:bg-slate-800 text-white px-8 py-3">Call (949) 579-2057</Button>
              </a>
              <a href="/contact">
                <Button variant="ghost" className="border border-slate-300 px-8 py-3">Get Pre-Approved</Button>
              </a>
            </div>
          </div>
        </div>
