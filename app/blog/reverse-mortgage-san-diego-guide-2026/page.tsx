...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'reverse mortgage La Jolla',
    'reverse mortgage Coronado',
    'reverse mortgage Carlsbad',
    'reverse mortgage Encinitas',
    'San Diego seniors home equity',
    'reverse mortgage California 2026',
    'proprietary reverse mortgage San Diego',
  ...
  alternates: {
    canonical: 'https://www.mothebroker.com/blog/reverse-mortgage-san-diego-guide-2026',
    languages: {
      'en-US': 'https://www.mothebroker.com/blog/reverse-mortgage-san-diego-guide-2026',
      'x-default': 'https://www.mothebroker.com/blog/reverse-mortgage-san-diego-guide-2026',
    },
  },
};

export default function ReverseMortgageSanDiegoGuidePage() {
  return (
    <article className="max-w-4xl mx-auto px-4 py-12">
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "mainEntityOfPage": "https://www.mothebroker.com/blog/reverse-mortgage-san-diego-guide-2026",
            "about": {
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "mainEntity": [
              ...
              {
                "@type": "Question",
                "name": "Can I get a reverse mortgage on a Del Mar oceanfront home?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Yes, Del Mar oceanfront homes qualify for reverse mortgages. With median values around $3.8 million, most Del Mar properties exceed the HECM limit, making proprietary reverse mortgage programs the preferred option for accessing maximum equity."
                }
              },
              {
                "@type": "Question",
                "name": "Do Rancho Santa Fe estate properties qualify for reverse mortgages?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Yes, Rancho Santa Fe estates qualify for reverse mortgages regardless of property size or acreage. Properties valued at $4.5 million and above use proprietary programs designed specifically for high-value California homes. The property must serve as your primary residence."
                }
              },
              {
                "@type": "Question",
                "name": "Is HUD counseling required for San Diego reverse mortgages?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Yes, HUD-approved counseling is mandatory for all HECM reverse mortgages in San Diego. The session covers program costs, alternatives, and repayment obligations. Several HUD-approved counseling agencies operate in the San Diego metro area, and phone or video sessions are also available."
                }
              },
              {
                "@type": "Question",
                "name": "How does a reverse mortgage work for Coronado military retirees?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Military retirees in Coronado who are 62 or older can access home equity through reverse mortgages. Military pensions and VA benefits count toward the financial assessment. Many Coronado retirees have built significant equity over long military careers, making them strong candidates for HECM or proprietary programs."
                }
              },
              {
                "@type": "Question",
              ...
              {
                "@type": "Question",
                "name": "Can La Jolla condo owners get reverse mortgages?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Yes, La Jolla condominium owners can qualify for reverse mortgages. FHA-approved condos qualify for HECM, while non-FHA-approved condos may qualify under proprietary programs. High-rise oceanfront condos with values exceeding $2 million typically use proprietary programs for maximum proceeds."
                }
              },
              {
                "@type": "Question",
                "name": "Do I lose ownership of my San Diego home with a reverse mortgage?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "No. You retain full ownership and title to your San Diego home with a reverse mortgage. You continue living in the home as long as it remains your primary residence, you maintain the property, and you stay current on property taxes and homeowners insurance."
                }
              },
              {
                "@type": "Question",
                "name": "What payout options are available for San Diego reverse mortgages?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "San Diego homeowners can choose from five HECM payout options: lump sum, monthly tenure payments for life, term payments for a set period, line of credit with a growth feature, or any combination. The line of credit option is the most popular because unused funds grow over time."
                }
              },
              {
                "@type": "Question",
                "name": "How much equity can Carlsbad seniors access through a reverse mortgage?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Carlsbad seniors with median home values around $1.3 million can access a significant portion of their equity. A 72-year-old homeowner with a paid-off $1.3 million Carlsbad home could access approximately $650,000 to $750,000 through HECM. Exact amounts depend on age, home value, and current interest rates."
                }
              },
              {
                "@type": "Question",
                "name": "Are reverse mortgages safe for San Diego seniors?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "HECM reverse mortgages are federally regulated and FHA-insured, providing significant consumer protections. These include mandatory HUD counseling, non-recourse protection (you never owe more than the home's value), and spousal protections for non-borrowing spouses. Proprietary programs offer similar protections in most cases."
                }
              },
              {
                "@type": "Question",
                "name": "Can I use reverse mortgage funds to pay off my existing San Diego mortgage?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Yes, one of the most common uses of reverse mortgage proceeds is paying off an existing mortgage. This eliminates monthly mortgage payments, freeing up cash flow for San Diego's high cost of living while allowing you to remain in your home."
                }
              },
              {
                "@type": "Question",
                "name": "What happens to my San Diego home when I pass away with a reverse mortgage?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Your heirs inherit the home and have options: repay the reverse mortgage balance and keep the property, sell the home and keep any equity above the loan balance, or allow the lender to sell. HECM loans are non-recourse, meaning heirs never owe more than the home's appraised value."
                }
              },
              {
                "@type": "Question",
                "name": "How long does a reverse mortgage take to close in San Diego?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "A reverse mortgage in San Diego typically takes 30 to 45 days from application to closing. This includes HUD counseling (which must be completed before application), appraisal, underwriting, and a mandatory 3-day right of rescission period after closing."
                }
              }
            ]
          })
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "hasOfferCatalog": {
              ...
              "itemListElement": [
                { "@type": "Offer", "itemOffered": { "@type": "FinancialProduct", "name": "HECM Reverse Mortgage" } },
                { "@type": "Offer", "itemOffered": { "@type": "FinancialProduct", "name": "Proprietary Reverse Mortgage" } }
              ]
            }
          })
        }}
      ...
      <section className="prose prose-lg max-w-none">
        ...
        {/* Bing Power Block - 8-City Table */}
        <h2>San Diego County Reverse Mortgage Overview: 8-City Comparison</h2>
        <p>
          ...
          <table className="min-w-full bg-white border border-gray-200">
            <thead>
              <tr className="bg-gray-100">
                ...
                <th className="py-3 px-4 text-left font-semibold border-b">Est. Available Equity (Age 72)</th>
            ...
            <tbody>
              <tr>
                ...
                <td className="py-3 px-4 border-b">Proprietary</td>
                <td className="py-3 px-4 border-b">$1,800,000 - $2,250,000</td>
              ...
              <tr className="bg-gray-50">
                ...
                <td className="py-3 px-4 border-b">Proprietary</td>
                <td className="py-3 px-4 border-b">$1,520,000 - $1,900,000</td>
              ...
              <tr>
                ...
                <td className="py-3 px-4 border-b">Proprietary</td>
                <td className="py-3 px-4 border-b">$1,000,000 - $1,250,000</td>
              ...
              <tr className="bg-gray-50">
                ...
                <td className="py-3 px-4 border-b">Proprietary</td>
                <td className="py-3 px-4 border-b">$880,000 - $1,100,000</td>
              ...
              <tr>
                ...
                <td className="py-3 px-4 border-b">Proprietary</td>
                <td className="py-3 px-4 border-b">$800,000 - $1,000,000</td>
              ...
              <tr className="bg-gray-50">
                ...
                <td className="py-3 px-4 border-b">Proprietary</td>
                <td className="py-3 px-4 border-b">$720,000 - $900,000</td>
              ...
              <tr>
                ...
                <td className="py-3 px-4 border-b">HECM or Proprietary</td>
                <td className="py-3 px-4 border-b">$520,000 - $750,000</td>
              ...
              <tr className="bg-gray-50">
                ...
                <td className="py-3 px-4">$440,000 - $630,000</td>
        ...
        <h2>Reverse Mortgage Qualification Requirements in San Diego</h2>
        <p>
          ...
          <table className="min-w-full bg-white border border-gray-200">
            <thead>
              <tr className="bg-gray-100">
                ...
                <th className="py-3 px-4 text-left font-semibold border-b">HECM (FHA-Insured)</th>
                <th className="py-3 px-4 text-left font-semibold border-b">Proprietary (Jumbo)</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td className="py-3 px-4 border-b font-medium">Minimum Age</td>
                <td className="py-3 px-4 border-b">62 years old</td>
                <td className="py-3 px-4 border-b">62 years old (some allow 60)</td>
              </tr>
              <tr className="bg-gray-50">
              ...
              <tr>
                ...
                <td className="py-3 px-4 border-b">SFR, 2-4 units, FHA-approved condos</td>
                <td className="py-3 px-4 border-b">SFR, condos, townhomes</td>
              </tr>
              <tr className="bg-gray-50">
                <td className="py-3 px-4 border-b font-medium">HUD Counseling</td>
                <td className="py-3 px-4 border-b">Required (mandatory)</td>
                <td className="py-3 px-4 border-b">Varies by lender</td>
              </tr>
              <tr>
                <td className="py-3 px-4 border-b font-medium">FHA Mortgage Insurance</td>
                <td className="py-3 px-4 border-b">Yes (2% initial + 0.5% annual)</td>
                <td className="py-3 px-4 border-b">No</td>
              </tr>
              <tr className="bg-gray-50">
                <td className="py-3 px-4 border-b font-medium">Non-Recourse Protection</td>
                <td className="py-3 px-4 border-b">Yes (FHA guarantee)</td>
                <td className="py-3 px-4 border-b">Yes (most programs)</td>
              </tr>
              <tr>
                <td className="py-3 px-4 font-medium">Financial Assessment</td>
                <td className="py-3 px-4">Required (income, credit, taxes)</td>
                <td className="py-3 px-4">Required (varies by lender)</td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <h2>Reverse Mortgage Payout Options for San Diego Homeowners</h2>
        <p>
          ...
          <table className="min-w-full bg-white border border-gray-200">
            <thead>
              <tr className="bg-gray-100">
                ...
                <th className="py-3 px-4 text-left font-semibold border-b">San Diego Scenario</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td className="py-3 px-4 border-b font-medium">Lump Sum</td>
                <td className="py-3 px-4 border-b">One-time disbursement at closing</td>
                <td className="py-3 px-4 border-b">Paying off existing mortgage</td>
                <td className="py-3 px-4 border-b">Carlsbad senior pays off $400K mortgage, eliminates monthly payment</td>
              </tr>
              <tr className="bg-gray-50">
                <td className="py-3 px-4 border-b font-medium">Tenure</td>
                <td className="py-3 px-4 border-b">Monthly payments for life</td>
                <td className="py-3 px-4 border-b">Supplementing retirement income</td>
                <td className="py-3 px-4 border-b">Encinitas retiree receives $3,200/month for life</td>
              </tr>
              <tr>
                <td className="py-3 px-4 border-b font-medium">Term</td>
                <td className="py-3 px-4 border-b">Monthly payments for set period</td>
                <td className="py-3 px-4 border-b">Bridge to Social Security or pension</td>
                <td className="py-3 px-4 border-b">Poway homeowner receives $5,500/month for 10 years</td>
              </tr>
              <tr className="bg-gray-50">
                <td className="py-3 px-4 border-b font-medium">Line of Credit</td>
                <td className="py-3 px-4 border-b">Draw funds as needed; unused balance grows</td>
                <td className="py-3 px-4 border-b">Emergency reserves, flexibility</td>
                <td className="py-3 px-4 border-b">La Jolla senior establishes $1M credit line, draws as needed</td>
              </tr>
              <tr>
                <td className="py-3 px-4 font-medium">Combination</td>
                <td className="py-3 px-4">Mix of any options above</td>
                <td className="py-3 px-4">Customized retirement strategy</td>
                <td className="py-3 px-4">Del Mar homeowner: $200K lump sum + $600K credit line</td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        {/* Market Overview */}
        <h2>San Diego County Housing Market: Why Reverse Mortgages Make Sense in 2026</h2>
        <p>
        ...
        <h3>Biotech and Life Sciences Corridor</h3>
        <p>
        ...
        <h3>Military Economy and Retirement</h3>
        <p>
        ...
        <h3>Tourism and Coastal Lifestyle</h3>
        <p>
        ...
        <h3>Rancho Santa Fe: Equestrian Estates</h3>
        <p>
        ...
        <h3>Solana Beach: Coastal Sophistication</h3>
        <p>
        ...
        <h3>Encinitas: Surf-Culture Wealth</h3>
        <p>
        ...
        <h3>Coronado: Island Lifestyle and Military Heritage</h3>
        <p>
        ...
        <h3>Carlsbad: Resort Living and Biotech Access</h3>
        <p>
        ...
        {/* E-E-A-T Section */}
        <h2>Why Work with a Licensed Reverse Mortgage Specialist in San Diego</h2>
        <p>
        ...
        <div className="bg-gray-50 p-6 rounded-xl border border-gray-200 my-8">
          ...
          <ul className="space-y-2">
            <li><a href="/blog/home-equity-san-diego-guide-2026" className="text-blue-600 hover:underline font-medium">San Diego Home Equity Guide: HELOC, HELOAN & Cash-Out</a> &mdash; Compare equity products for San Diego homeowners of all ages</li>
        ...
        {/* FAQ Section */}
        <h2>Frequently Asked Questions: Reverse Mortgages in San Diego</h2>
        ...
        <h3>Is HUD counseling required for San Diego reverse mortgages?</h3>
        <p>
        ...
        <h3>How does a reverse mortgage work for Coronado military retirees?</h3>
        <p>
        ...
        <h3>Do I lose ownership of my San Diego home with a reverse mortgage?</h3>
        <p>
        ...
        <h3>What payout options are available for San Diego reverse mortgages?</h3>
        <p>
        ...
        <h3>How much equity can Carlsbad seniors access through a reverse mortgage?</h3>
        <p>
        ...
        <h3>Are reverse mortgages safe for San Diego seniors?</h3>
        <p>
        ...
        <h3>Can I use reverse mortgage funds to pay off my existing San Diego mortgage?</h3>
        <p>
        ...
        <h3>What happens to my San Diego home when I pass away with a reverse mortgage?</h3>
        <p>
        ...
        <h3>How long does a reverse mortgage take to close in San Diego?</h3>
        <p>
