        ...
        <section className="mb-12">
          ...
          <ol className="space-y-3 text-slate-600 mb-6">
            ...
            <li className="flex gap-3">
              ...
              <span><strong>Wholesale broker access</strong> &mdash; comparing equity products and DSCR loans across 50+ Wholesale Lenders through a wholesale broker ensures the best combined rate strategy</span>
            </li>
          </ol>
        </section>
