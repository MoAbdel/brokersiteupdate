    ...
    <article className="max-w-4xl mx-auto px-4 py-12">
      ...
      <section className="prose prose-lg max-w-none">
        ...
        <div className="expert-summary bg-blue-50 border-l-4 border-blue-500 p-6 rounded-r-lg my-8">
          ...
          <p className="text-blue-800 mb-0">
            <strong>Ready to explore your Eastside reverse mortgage options?</strong> Call Mo Abdel at <a href="tel:9495792057" className="text-blue-700 font-bold underline">(949) 579-2057</a> or email <a href="mailto:mo@mothebroker.com" className="text-blue-700 font-bold underline">mo@mothebroker.com</a> for a confidential, no-obligation jumbo reverse mortgage analysis for your ultra-luxury estate.
          </p>
        </div>
