...
export const metadata: Metadata = {
  ...
  description: 'Save $47K+ on your RSM mortgage. Wholesale rates from 50+ Wholesale Lenders — 0.25-0.5% below banks. FHA 3.5% down, VA $0 down, conforming & jumbo for every RSM village. Pre-approval in 48 hours. Call or Text (949) 579-2057.',
        ...
        <section className="mb-12">
          ...
          <div className="bg-slate-50 border border-slate-200 rounded-lg p-4">
            <p className="text-slate-900 text-sm">
              <strong>Neighborhood Selection Tip:</strong> In our RSM closings, we help buyers match their budget and lifestyle to the right neighborhood before starting the loan process. A family qualifying for $900,000 has fundamentally different neighborhood options than a family qualifying for $650,000. The right wholesale mortgage program &mdash; whether conventional, FHA, VA, or bank statement &mdash; depends on the target neighborhood&apos;s price point and HOA structure. Call or Text (949) 579-2057 for a personalized neighborhood-by-neighborhood financing analysis.
            </p>
          </div>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-slate-50 rounded-xl p-6">
              ...
              <p className="text-slate-600 text-sm">Rates change daily based on market conditions. A wholesale broker provides real-time rate comparisons from 50+ Wholesale Lenders with a single credit pull, ensuring you see the lowest available rate for your specific credit profile and loan scenario. Call or Text (949) 579-2057 for today&apos;s wholesale rates.</p>
            </div>
