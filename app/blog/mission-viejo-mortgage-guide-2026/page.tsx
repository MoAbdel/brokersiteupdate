...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://mothebroker.com/blog/mission-viejo-mortgage-guide-2026',
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "mainEntity": {
              "@type": "WebPage",
              "@id": "https://mothebroker.com/blog/mission-viejo-mortgage-guide-2026",
              "significantLink": [
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        ...
        <section className="mt-12 pt-8 border-t border-slate-200">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <Link href="/blog/laguna-niguel-refinance-guide-2026" className="text-green-600 hover:text-green-700 hover:underline">
