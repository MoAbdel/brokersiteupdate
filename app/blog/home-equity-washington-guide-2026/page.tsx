    ...
    <>
      ...
      <article className="max-w-4xl mx-auto px-4 py-12">
        ...
        <section className="prose prose-lg max-w-none">
          ...
          <p>
            <em>I have worked with hundreds of tech industry borrowers across the Seattle Eastside and Greater Seattle. The difference between a retail lender and my wholesale approach is stark: retail banks often see complex compensation and say &quot;no.&quot; I see the same compensation and find the lender who says &quot;yes&quot; at a competitive rate. That is the power of having 50+ Wholesale Lenders.</em> — Mo Abdel, NMLS #1426884
          </p>
