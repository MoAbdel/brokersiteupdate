        ...
        <div className="overflow-x-auto my-6">
          <table className="min-w-full">
            ...
            <tbody>
              ...
              <tr><td className="py-2 px-4 border-b font-semibold">VA Jumbo Options</td><td className="py-2 px-4 border-b">Limited</td><td className="py-2 px-4 border-b text-blue-700 font-semibold">Multiple VA Lenders</td></tr>
              <tr><td className="py-2 px-4 border-b font-semibold">Super Jumbo ($3M+)</td><td className="py-2 px-4 border-b">Limited</td><td className="py-2 px-4 border-b text-blue-700 font-semibold">30+ Lenders</td></tr>
