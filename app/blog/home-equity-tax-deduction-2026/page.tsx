...
const faqData = [
  ...
  },
  {
    ...
    answer: 'Yes. Your lender provides Form 1098 (Mortgage Interest Statement) showing the interest paid during the tax year. You report deductible mortgage interest on Schedule A (Itemized Deductions) of your federal tax return. You must itemize deductions to claim the mortgage interest deduction—it is not available if you take the standard deduction ($15,700 single / $31,400 married filing jointly for 2026).',
  },
  {
    question: 'Can I deduct home equity interest if I take the standard deduction?',
    answer: 'No. The mortgage interest deduction is an itemized deduction. You must file Schedule A and choose to itemize deductions instead of taking the standard deduction. For 2026, the standard deduction is approximately $15,700 for single filers and $31,400 for married filing jointly. You should only itemize if your total itemized deductions (including mortgage interest, state/local taxes, charitable contributions, etc.) exceed the standard deduction amount.',
  },
  {
      ...
      <section className="prose prose-lg max-w-none">
        ...
        <div className="bg-yellow-50 p-6 rounded-lg border border-yellow-200 mb-8">
          ...
          <p className="text-yellow-900 mb-0">
            This article is for <strong>educational purposes only</strong> and does not constitute tax advice. Tax laws are complex and individual circumstances vary. Always consult with a qualified tax professional (CPA or tax attorney) before making decisions based on potential tax deductions. Mo Abdel and Lumin Lending are mortgage professionals, not tax advisors.
          </p>
        </div>
        ...
        <p>
          The <strong>Tax Cuts and Jobs Act</strong>, signed into law on December 22, 2017 and effective for tax years 2018 through 2025, fundamentally changed the rules for deducting home equity loan and HELOC interest. While the TCJA technically &quot;expired&quot; at the end of 2025, as of February 2026, the rules remain effectively in place pending congressional action.
        </p>
        ...
        <h3>Example: Over-Limit Proration</h3>
        ...
        <div className="bg-gray-50 p-6 rounded-lg border border-gray-200 my-6">
          ...
          <p className="font-semibold text-gray-900 mt-4">Calculation:</p>
          <ul>
        ...
        <p>
          Proper documentation is the foundation of a defensible tax deduction. The IRS can request proof of how home equity funds were used for up to <strong>three years after filing</strong> (six years if substantial income is underreported). Here is a system I recommend to every borrower:
        </p>
        ...
        <h3>Step 3: Calculate the Deductible Portion</h3>
        ...
        <div className="bg-yellow-50 p-6 rounded-lg border border-yellow-200 my-6">
          <h4 className="font-bold text-yellow-800 mt-0">Pro Tip: The IRS Tracing Rules</h4>
          <p className="text-yellow-900 mb-0">
            The IRS uses <strong>&quot;tracing rules&quot;</strong> (Treasury Regulation 1.163-8T) to determine the character of interest based on how borrowed funds are actually used. This means the IRS can trace where your home equity dollars went. If you deposited $100,000 into your regular checking and paid some bills, bought a car, and then did a renovation, the IRS traces each dollar. The dedicated account approach eliminates this complexity and makes the trail clear.
          </p>
        </div>
        ...
        <h3>Mixed-Use Allocation Examples</h3>
        ...
        <p>
          HELOCs present a unique tracking challenge because you make multiple draws over time. Each draw must be tracked individually for its qualifying purpose:
        </p>
        ...
        <ol>
          ...
          <li><strong>Calculate the weighted average</strong> of qualifying vs non-qualifying draws</li>
          <li><strong>Apply the ratio to total interest</strong> paid during the tax year</li>
          <li><strong>Recalculate annually</strong> as the mix of draws and repayments changes</li>
        </ol>
        ...
        <div className="bg-blue-50 p-6 rounded-lg border border-blue-200 my-6">
          ...
          <p className="text-blue-800 mb-0">
            When I structure a cash-out refinance for clients who plan to use some funds for improvements and some for personal use, I always recommend they <strong>take two separate draws or document the split clearly</strong>. The cleaner your paper trail, the easier it is to defend the deduction. Some clients decide to do a smaller cash-out limited to the improvement amount and use a separate HELOC for personal needs—keeping the tax treatment completely clean. — <strong>Mo Abdel, NMLS #1426884</strong>
          </p>
        </div>
          ...
          <table className="min-w-full border border-gray-200">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td className="border border-gray-200 px-4 py-2">Must exceed to benefit from itemizing</td>
              </tr>
              <tr>
        ...
        <div className="bg-blue-50 p-6 rounded-lg border border-blue-200 my-6">
          ...
          <ol className="text-blue-800">
            ...
            <li><strong>You must itemize</strong> on Schedule A to claim the deduction (standard deduction is $31,400 MFJ for 2026)</li>
        ...
        <div className="bg-green-50 p-8 rounded-xl border border-green-200 my-8 text-center">
          <h3 className="text-2xl font-bold text-green-900 mt-0">Structure Your Home Equity Loan for Maximum Tax Benefit</h3>
          <p className="text-green-800 text-lg mb-4">
            I help homeowners choose the right home equity product and structure it to maximize potential tax benefits. Whether you need a HELOC for a renovation project, a home equity loan for a major remodel, or a cash-out refinance, I will walk you through the options and connect you with a tax professional to confirm the deduction.
          </p>
      ...
      <footer className="mt-12 pt-8 border-t border-gray-200">
        <div className="bg-gray-100 p-6 rounded-lg">
          <p className="text-sm text-gray-600">
            ...
            <br />
            Equal Housing Lender. All loans subject to credit approval, underwriting guidelines, and program availability. <strong>Tax Disclaimer:</strong> This article is for educational and informational purposes only and does not constitute tax, legal, or financial advice. Tax laws are complex and subject to change. The information presented reflects general rules under the Tax Cuts and Jobs Act as understood in February 2026. Individual tax situations vary. Always consult with a qualified tax professional (CPA, enrolled agent, or tax attorney) before making decisions based on potential tax deductions. Mo Abdel and Lumin Lending are mortgage professionals and do not provide tax advice.
          </p>
        </div>
      </footer>
    </article>
