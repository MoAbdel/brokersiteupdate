        ...
        <div className="overflow-x-auto my-6">
          <table className="min-w-full">
            ...
            <tbody>
              ...
              <tr><td className="py-2 px-4 border-b font-semibold">Bank Statement Jumbo</td><td className="py-2 px-4 border-b">Rare</td><td className="py-2 px-4 border-b text-blue-700 font-semibold">Extensive</td></tr>
