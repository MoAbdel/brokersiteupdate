      ...
      <section className="prose prose-lg max-w-none">
        ...
        <div className="bg-green-50 p-8 rounded-xl border border-green-200 my-8 text-center">
          ...
          <p className="text-green-800 text-sm mt-3">
            Licensed in California and Washington. I work with 50+ Wholesale Lenders to find the best reverse mortgage terms for your specific situation. Free consultation, no obligation.
          </p>
        </div>
