...
export default function VALoansOrangeCountyPage() {
  return (
    <article className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      <Breadcrumbs pathname="/va-loans-orange-county" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="text-center bg-slate-900 rounded-2xl p-8 text-white" aria-label="Contact Mo Abdel to start your VA loan application">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="tel:9495792057">
              <Button variant="ghost" className="border-2 border-white text-white hover:bg-white hover:text-slate-900 px-8 py-3 text-lg" aria-label="Call VA expert Mo Abdel at (949) 579-2057">
