        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-lg max-w-none text-slate-700">
            ...
            <p className="leading-relaxed mb-6">
              I was born and raised right here in OC—from beach days in Newport to Friday night football games in Irvine. I know these neighborhoods because I grew up in them. I understand what it means to put down roots here, to raise a family here, and to build a future in one of California's most beautiful communities.
            </p>
