...
export const metadata: Metadata = {
  ...
  alternates: {
    ...
    languages: {
      'en-US': 'https://www.mothebroker.com/terms-of-service',
      'x-default': 'https://www.mothebroker.com/terms-of-service',
    },
  },
};
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-blue-50 border-l-4 border-blue-400 p-6 mb-8">
          <div className="flex">
            <Scale className="w-6 h-6 text-blue-600 mr-3 mt-1" />
            <div>
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-slate-700 mb-4">
              ...
              Mohammad Abdelfattah, NMLS #1426884, operating as a licensed mortgage loan originator with Lumin Lending
          ...
          <section className="mb-8">
            ...
            <div className="bg-blue-50 p-6 rounded-lg mb-4">
              ...
              <ul className="list-disc pl-6 text-slate-700">
                ...
                <li><strong>Licensed States:</strong> California, Washington</li>
              </ul>
            </div>
          </section>
